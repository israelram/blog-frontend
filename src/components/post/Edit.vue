<template>
    <div>
        <h4 class="text-center mt-20">
            <small>
                <button class="btn btn-success" v-on:click="navigate()"> View All Post </button>
            </small>
        </h4>
        <div class="col-md-12 form-wrapper">
            <h2> Edit Post </h2>
            <form action="" id="edit-post-form" @submit.prevent="editPost">
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea name="" id="body" cols="30" rows="5" v-model="post.body" class="form-control"></textarea>
                </div>
                <div class="form-group col-md-12">
                    <label for="author">Author </label>
                    <input type="text" id="autor" v-model="post.author" name="author" class="form-control">
                </div>
